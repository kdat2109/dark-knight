    ...
    public class TextTrackMixerBehaviour : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            for (int i = 0; i < inputCount; i++)
            {
                ...
                var length = Mathf.RoundToInt(Mathf.Lerp(0, input.text.Length, inputWeight));
            ...
            //var length = Mathf.RoundToInt(Mathf.Lerp(0, text.Length, totalWeight));
            // m_TrackBinding.text = text.Substring(0,length);
            //m_TrackBinding.text = totalWeight.ToString("0.0");
        }
